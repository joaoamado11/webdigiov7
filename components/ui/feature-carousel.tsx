...
const steps: readonly Step[] = [
  {
    ...
    description:
      "We dive deep into your brand, audience, and goals. Every pixel we design starts with strategy — not assumptions.",
  },
  {
    id: "2",
    name: "Design",
    ...
    description:
      "Wireframes become living prototypes. Our design team iterates with you, refining every interaction until it feels effortless.",
  },
  {
    id: "3",
    name: "Build",
    title: "Engineering at full stack depth",
    description:
      "Next.js, React, and cloud-native infrastructure. We write the code that powers your product — clean, tested, and ready to scale.",
  },
  {
    id: "4",
    name: "Launch",
    ...
    description:
      "Deploy with confidence. We handle CI/CD, monitoring, and post-launch iteration so your product keeps getting better.",
  },
] as const;
    ...
    >
      <div
        ...
        style={{
          ...
          background: "linear-gradient(180deg, rgba(14,20,16,0.97) 0%, rgba(26,35,32,0.95) 100%)",
        }}
      >
        <div className="m-10 min-h-[450px] w-full">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                <p className="text-sm leading-5 text-neutral-300 sm:text-base sm:leading-6 dark:text-zinc-400">
                ...
                <span className="flex items-center gap-2 text-sm font-medium">
                  <motion.span
                    ...
                    className={cn(
                      ...
                      isCompleted && "bg-[#3db5b0] text-white",
                      isCurrent && "bg-[#7c5cfc]/80 text-neutral-400",
                  ...
                  >
                    {isCompleted ? (
                      ...
                      <span
                        className={cn("text-xs", !isCurrent && "text-[#3db5b0]")}
                      >
                        {stepIdx + 1}
                      </span>
                    )}
...
Component.displayName = "FeatureCarousel";
